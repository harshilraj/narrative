...
export default function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[88vh] md:min-h-screen flex flex-col justify-center overflow-hidden bg-transparent">
      ...
      <div className="container relative z-20 flex flex-col items-center justify-center text-center px-4" ref={contentRef}>
        ...
        {/* Center Content */}
        <div className="flex flex-col items-center max-w-4xl mt-20 md:mt-28">
          
          {/* Operational Strip */}
          <div data-reveal className="mb-10 md:mb-12 flex items-center gap-3 px-5 py-2 rounded-full bg-white/[0.02] border border-white/5 backdrop-blur-md">
            <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(52,211,153,0.6)]" />
            <span className="text-[9px] uppercase tracking-widest text-white/60 font-medium">Operations layer online</span>
            <span className="text-white/10 text-[9px]">|</span>
            <span className="text-[9px] uppercase tracking-widest text-white/40">Real systems, not demos</span>
          </div>
          ...
          <div data-reveal className="mt-10 md:mt-12 flex flex-col sm:flex-row items-center gap-4">
            <a href="#contact" className="px-7 py-3.5 bg-white text-black text-[11px] uppercase tracking-[0.2em] font-bold rounded hover:bg-white/90 transition-colors">
              Plan my system
            </a>
            <a href="#infrastructure" className="px-7 py-3.5 bg-transparent border border-white/10 text-white/80 text-[11px] uppercase tracking-[0.2em] font-medium rounded hover:bg-white/5 transition-colors">
